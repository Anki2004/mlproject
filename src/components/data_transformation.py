...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            preprocessor = ColumnTransformer(
                [("num_pipeline",numerical_column ,num_pipeline),
                ("cat_pipeline",categorical_column,cat_pipeline)]
            )
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            preprocessor.obj = self.data_transformation_object()
            ...
            input_feature_train_arr = preprocessing.obj.fit_transform(input_feature_train_df)
            input_feature_test_arr = preprocessing.obj.transform(input_feature_train_df)
